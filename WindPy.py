...
class w:
    ...
    for x in sys.path:
        ...
        if( ix>=0 and x[ix:]=='site-packages'):
          sitepath=x;
          break;
    #sitepath=sitepath+ r"D:\PycharmProjects\GUI\PyQt5_Image22\WindPy.pth"
    # sitepath = r"D:\PycharmProjects\GUI\PyQt5_Image44\WindPy.pth"
    # #sitepath = r"C:\Wind\Wind.NET.Client\WindNET\x64\WindPy.pth"
    # pathfile=open(sitepath)
    # dllpath=pathfile.readlines();
    # pathfile.close();

    #sitepath=dllpath[0]+ r"D:\PycharmProjects\GUI\PyQt5_Image22\WindPy2.pth"
    #sitepath = r"D:\PycharmProjects\GUI\PyQt5_Image44\WindPy.dll"
    sitepath = r"C:\Wind\Wind.NET.Client\WindNET\x64\WindPy.dll"
